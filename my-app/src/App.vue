<template>
  <div id="app h-100">
    ...
    <div class="d-flex flex-row justify-content-center p-2 text-center" v-if="drawKeyVisibility">
      <div class="align-self-center m-2 txt">Выделите ключ {{ message }} и нажмите кнопку</div>
    ...
    <PSPDFKitContainer :pdfFile="pdfFile" v-on:click="onClick" @loaded="handleLoaded" />
...
export default {
  ...
  methods: {
    ...
    handleLoaded(instance) {
      ...
      //delete annotation toolbar
      let a = document.getElementById("app");
      let b = (a.querySelectorAll('[class="PSPDFKit-Container"]'));
      let c = b[0].firstChild;
      let d = c.contentDocument.body;
      a = d.querySelectorAll('[class="PSPDFKit-Toolbars PSPDFKit-6rzkyc987bqyetscyfvr4nf3f2"]');
      console.log(a);
